            ...
            >
                ...
                <div className="mt-6 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className={`rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 ${!isFormValid() ? 'opacity-50 cursor-not-allowed' : ''}`}
                ...
                {errorMsg && (
                    <div className="mt-2 text-center text-sm text-red-600">{errorMsg}</div>
                )}
            </div>
        </div>
    );
