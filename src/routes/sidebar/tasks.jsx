      ...
      {user.user_role === "Staff" && (
        <div className=" ">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
              ...
              >
                ...
                {cases.map((c) => (
                  <option key={c.case_id} value={c.case_id}>
                    #{c.case_id} - {c.case_title || c.case_remarks || "Untitled Case"}
                  </option>
                ))}
              </select>
              {casesError && (
            ...
            <button
              className="w-full rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
